...
try:
    ...
    _import_structure["modeling_flax_codegen"] = [
        "FlaxCodeGenForCausalLM",
        "FlaxCodeGenModel",
        "FlaxCodeGenPreTrainedModel",
    ]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .modeling_flax_codegen import FlaxCodeGenForCausalLM, FlaxCodeGenModel, FlaxCodeGenPreTrainedModel
