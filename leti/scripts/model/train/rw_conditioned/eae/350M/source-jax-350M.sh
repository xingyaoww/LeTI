...
function train() {
    ...
    python3 \
        ...
        --max_gen_length 1280 \
        --postprocess_generation eae \
        --execution_timeout 30 \
        --execution_extra_headers "from __future__ import annotations" \
        $EXTRA_ARGS
